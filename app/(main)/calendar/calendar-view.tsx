          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              {selectedTournament?.sourceUrl && (
                <a href={selectedTournament.sourceUrl} target="_blank" rel="noopener noreferrer" className="flex-1 bg-white/5 hover:bg-white/10 text-foreground py-2.5 rounded-lg text-sm font-medium text-center flex items-center justify-center gap-1.5 transition-colors">Перейти к турниру <ExternalLink className="w-4 h-4" /></a>
              )}
